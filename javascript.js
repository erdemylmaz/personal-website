...
const langTR = document.querySelector('#tr');
...
class Theme {
  ...
  darkMode = () => {
    ...
    langTR.style.color = "gray";
    langTR.onmouseover = () => langTR.style.color = "black";
    langTR.onmouseleave = () => langTR.style.color = "gray";
  ...
  lightMode = () => {
    ...
    langTR.style.color = "white";
    langTR.onmouseover = () => langTR.style.color = "black";
    langTR.onmouseleave = () => langTR.style.color = "white";
